...
func (m *MockGithubClient) CompareCommits(ctx context.Context, owner, repo, base, head string, count int) (*internal.CommitComparison, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CompareCommits", ctx, owner, repo, base, head, count)
	ret0, _ := ret[0].(*internal.CommitComparison)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGithubClient) CreateRelease(ctx context.Context, owner, repo, tag, body string, prerelease bool) (*internal.RepoRelease, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateRelease", ctx, owner, repo, tag, body, prerelease)
	ret0, _ := ret[0].(*internal.RepoRelease)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGithubClient) GetPullRequest(ctx context.Context, owner, repo string, number int) (*internal.BasePull, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPullRequest", ctx, owner, repo, number)
	ret0, _ := ret[0].(*internal.BasePull)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGithubClient) ListMergedPullsForCommit(ctx context.Context, owner, repo, sha string) ([]internal.BasePull, error) {
	m.ctrl.T.Helper()
